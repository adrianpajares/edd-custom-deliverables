	...
	public function add_custom_deliverables_fields_to_order_edit_screen(){
		...
		if ( ! empty( $payment->cart_details ) ) {
			...
			<div class="edd-custom-deliverables-send-email-wrapper edd-admin-box-inside">
				...
				<p>
					<span><?php echo __( 'If you\'d like to send an email to the customer to let them know their files are ready to download, you can do so below. ', 'edd-custom-deliverables' ); ?></span>
				</p>
				<p>
...
You can download them here: {custom_download_list}', 'edd_custom_deliverables_body' ), 'edd-custom-deliverables-email-body', array( 'textarea_rows' => 9, 'wpautop' => true ) ); ?>
				</p>
				<p>
					<?php $notify_button_text = __( 'Send Email', 'edd-custom-deliverables' ); ?><button class="button" id="edd-custom-deliverables-email-customer" data-payment="<?php echo $payment_id; ?>"><?php echo $notify_button_text; ?></button>
